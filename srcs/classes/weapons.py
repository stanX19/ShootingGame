...
class MainWeaponEnum:
    ...
    piercing_machine_gun = GeneralWeapon("piercing machine gun", reload=800, speed=25, max_count=1, radius=5, growth_factor=1,
    ...
    lazer_mini = GeneralWeapon("lazer mini", reload=200, speed=50, min_count=1, max_count=1, radius=2,
                       growth_factor=5, bullet_class=Lazer, lifespan=120, dmg=1, hp=25)
    lazer = GeneralWeapon("lazer", reload=200, speed=100, min_count=1, max_count=1, radius=2,
                       growth_factor=5, bullet_class=Lazer, lifespan=120, dmg=0.1, hp=100)
    giant_canon = GeneralWeapon("giant canon", reload=200, speed=50, max_count=1, radius=20, recoil=5, hp=10, dmg=10)
    lazer_super = GeneralWeapon("lazer super", reload=2000, speed=200, min_count=1, max_count=1, radius=5,
                             growth_factor=5, bullet_class=Lazer, lifespan=120, dmg=0.5, hp=200)
    ...
    missile = MissileWeapon("missile", 1000, max_count=8, min_count=2, growth_factor=1, dmg=10, hp=1,
                         radius=MISSILE_RADIUS, speed=MISSILE_SPEED)
    # spawner = GeneralWeapon("Spawner", reload=2000, speed=1, max_count=1, hp=3, radius=10,
    ...
    dancer = GeneralWeapon("dancer", reload=0, speed=(-5, 0), radius=2, dmg=0.1, hp=10,
...
class SubWeaponEnum:
    sub_missile = MissileWeapon("sub missile", 2000, MISSILE_SPEED, 8, min_count=2,
                             dmg=MainWeaponEnum.missile.bullet_kwargs.getattr('dmg'),
    ...
    sub_dancer = GeneralWeapon("sub dancer", reload=0, speed=(-5, 0), radius=2, dmg=0.0, hp=1,
                            min_count=1, max_count=5, growth_factor=1, spread=math.pi,
                            recoil=-10, lifespan=(1, 60), bullet_class=Lazer)
    sub_inverted_dancer = GeneralWeapon("sub inverted dancer", reload=0, speed=(0, 5), radius=2, dmg=0.0, hp=1,
                            min_count=1, max_count=5, growth_factor=1, spread=math.pi,
                            recoil=10, lifespan=(1, 60), bullet_class=Lazer)
